...
\newcommand{\universidad}{Universidad de Málaga}
\newcommand{\fecha}{XX de septiembre de 2026}
\newcommand{\grado}{Máster Universitario en Ciberseguridad}
\newcommand{\curso}{Curso 2025-2026}
\newcommand{\logoUniversidad}{figuras/marcaUMA.png}
...
% Permite cortes de página razonables en apartados que aún solo tienen título.
\newcommand{\apartadoPendiente}{\leavevmode\par\vspace{0.2\baselineskip}\pagebreak[1]}
